...
- Args:
  - `query`(required): type: string; Keywords to match (comma-separated for OR, e.g. "hiring,remote")
...
- Args:
  - `text`(required): type: string; Message text to send (e.g. "Thanks for reaching out")
